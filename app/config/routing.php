...
use Controller\user\Authentication;
...
$routes->add(
    'user_authentication',
    new Route('/user/authentication', ['_controller' => [Authentication::class, 'action']])
);
$routes->add(
    'logout',
    new Route('/user/logout', ['_controller' => [Logout::class, 'action']])
);
